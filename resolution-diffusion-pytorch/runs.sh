...
python celebA.py --time_steps 4 --resolution_routine 'Incremental_factor_2' --save_folder './celebA_4_steps_fac2_train'
...
python cifar10_train_nm_ohp.py --time_steps 3 --resolution_routine 'Incremental_factor_2' --save_folder './cifar10Aug_3_steps_fac2_train'

python cifar10_test_nm.py --time_steps 3 --train_routine 'Final' --sampling_routine 'x0_step_down' --resolution_routine 'Incremental_factor_2' --save_folder './cifar10_test' --load_path './cifar10_final_ckpt/model.pt' --test_type 'test_fid_distance_decrease_from_manifold'
